...
func (t *ardraTracer) CaptureStart(env *vm.EVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	t.env = env
	t.create = create
	t.to = to
...
func (t *ardraTracer) CaptureTxStart(gasLimit uint64) {
	t.gasLimit = gasLimit
}
...
func (t *ardraTracer) Stop(err error) {
	t.reason = err
...
func (t *ardraTracer) lookupAccount(addr common.Address) {
...
func (t *ardraTracer) lookupStorage(addr common.Address, key common.Hash) {
